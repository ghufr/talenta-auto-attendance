// Generated by Wrangler by running `wrangler types` (hash: 59c30bedf06484c3a5041c54936184db)
...
declare namespace Cloudflare {
	interface Env {
		...
		CRONS: [["57 0 * * mon,tue,wed","clock_in",1.1411766,104.119251],["7 10 * * mon,tue,wed","clock_out",1.1859393,104.0988311],["55 0 * * thu,fri","clock_in",1.1411766,104.119251],["5 10 * * thu,fri","clock_out",1.1859393,104.0988311]];
		HOUR_ID: string;
